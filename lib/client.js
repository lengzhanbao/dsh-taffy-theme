window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const TaffySettingsSchema = Schema.object({
			...
			displayName: Schema.string().default("Taffy"),
			subtitle: Schema.string().default("Taffy technical assistant"),
		...
		*/
		...
		function TaffyModeRow() {
			...
			return (0, react.createElement)("div", {
				...
				"data-dsh-taffy-settings": ""
			}, (0, react.createElement)("div", { className: "dsh-taffy-general-title" }, "Taffy 模式"), (0, react.createElement)("div", { className: "dsh-taffy-general-cubes" }, (0, react.createElement)(Cube, {
			...
			})), (0, react.createElement)("div", { className: "dsh-taffy-general-note" }, "开启后左右立绘与工房背景会跟着「外观」的浅色 / 深色切换。边框包住对话文本；百分比只改透明层，人物默认不透明。对话口吻请在 Agent 预设里选用「Taffy 塔菲」。"));
		}
