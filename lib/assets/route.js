...
export function resolveAssetPath(relativePath, assetsRoot = ASSETS_ROOT) {
...
export async function servePluginAsset(req, res, pathname, assetsRoot = ASSETS_ROOT, routePrefix = PLUGIN_ASSET_ROUTE_PREFIX) {
...
export function registerAssetRoute(ctx, assetsRoot = ASSETS_ROOT) {
