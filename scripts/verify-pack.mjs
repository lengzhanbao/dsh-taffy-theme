...
try {
  ...
  check('config.js 存在', existsSync(join(work, 'package/lib/config.js')))
  ...
  check('host index 可独立 import', out.includes('host-import-ok'))
} finally {
